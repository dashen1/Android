package com.example.opengl.customcamera.service;
...
public class CameraServiceImpl implements ICameraService{
    ...
    private static volatile CameraServiceImpl instance;

    private ICameraService.Config mConfig;
    ...
    public static CameraServiceImpl getInstance(){
        if (instance==null){
